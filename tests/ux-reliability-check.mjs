...
]) assert(existsSync(join(root, file)), `Missing v2.0.1 file: ${file}`);
...
assert(providerToggle.includes("v2.0.1 keeps provider setup explicit"), "ProviderTogglePanel must mention v2.0.1 provider setup clarity");
...
assert(docs.includes("v2.0.1"), "docs must identify v2.0.1");
...
console.log("UX Reliability + Empty State Polish checks passed for v2.0.1.");
process.exit(0);

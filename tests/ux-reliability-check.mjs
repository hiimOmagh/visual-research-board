...
]) assert(existsSync(join(root, file)), `Missing v2.1.3 file: ${file}`);
...
assert(providerToggle.includes("v2.1.3 keeps provider setup explicit"), "ProviderTogglePanel must mention v2.1.3 provider setup clarity");
...
assert(docs.includes("v2.1.3"), "docs must identify v2.1.3");
...
console.log("UX Reliability + Empty State Polish checks passed for v2.1.3.");
process.exit(0);

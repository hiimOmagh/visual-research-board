...
]) assert(existsSync(join(root, file)), `Missing v0.8.1 file: ${file}`);
...
assert(providerToggle.includes("v0.8.1 keeps provider setup explicit"), "ProviderTogglePanel must mention v0.8.1 provider setup clarity");
...
assert(docs.includes("v0.8.1"), "docs must identify v0.8.1");
...
console.log("UX Reliability + Empty State Polish checks passed for v0.8.1.");
process.exit(0);

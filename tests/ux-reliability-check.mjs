...
]) assert(existsSync(join(root, file)), `Missing v1.0.0 file: ${file}`);
...
assert(providerToggle.includes("v1.0.0 keeps provider setup explicit"), "ProviderTogglePanel must mention v1.0.0 provider setup clarity");
...
assert(docs.includes("v1.0.0"), "docs must identify v1.0.0");
...
console.log("UX Reliability + Empty State Polish checks passed for v1.0.0.");
process.exit(0);

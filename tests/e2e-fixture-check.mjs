...
const fixture = JSON.parse(readFileSync(join(root, "tests/fixtures/project-library-alpha8.json"), "utf8"));

// --- Library shape ---------------------------------------------------------

assert(fixture.schema_version === "0.1.0-alpha.8", "project library fixture must be alpha.8");
...
assert(active.schema_version === "0.1.0-alpha.8", "active project schema must be alpha.8");
...
console.log("E2E fixture checks passed for v0.1.0-alpha.8.");

...
assert(searchPanel.includes("visual-research-board-backup-v1.0.0.json"), "backup export filename must use v1.0.0");

const docs = read("docs/stock-illustrative-provider-pack.md");
for (const token of ["v1.0.0", "Pixabay", "Pexels", "Unsplash", "stock_illustrative", "npm run stock:providers:check"]) {
...
console.log("Stock/Illustrative Provider Pack checks passed for v1.0.0.");
process.exit(0);

...
assert(searchPanel.includes("visual-research-board-backup-v2.1.11.json"), "backup export filename must use v2.1.11");

const docs = read("docs/stock-illustrative-provider-pack.md");
for (const token of ["v2.1.11", "Pixabay", "Pexels", "Unsplash", "stock_illustrative", "npm run stock:providers:check"]) {
...
console.log("Stock/Illustrative Provider Pack checks passed for v2.1.11.");
process.exit(0);

...
for (const token of ["v0.2.11 routing gate", "Query expansion + source-class routing", "Source-class coverage", "Provider query caps", "manual reference launchers"]) {
...
for (const token of ["v0.2.11", "SourceClassRoutingPanel", "source_class_routing", "Expanded query variants", "visual-research-board-library-v0.2.11.json"]) {
...
assert(docs.includes("v0.2.11"), "routing docs must identify v0.2.11");
...
console.log("Query expansion + source-class routing checks passed for v0.2.11.");

...
assert(pkg.version === "0.2.3", "package version must be v0.2.3");
...
assert(docs.includes("v0.2.3"), "real retrieval validation docs must identify v0.2.3");
...
console.log("Retrieval evidence checks passed for v0.2.3.");

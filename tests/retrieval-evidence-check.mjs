...
assert(pkg.version === "0.2.7", "package version must be v0.2.7");
...
assert(docs.includes("v0.2.7"), "real retrieval validation docs must identify v0.2.7");
...
console.log("Retrieval evidence checks passed for v0.2.7.");

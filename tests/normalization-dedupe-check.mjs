...
assert(searchPanel.includes("v0.4.1"), "SearchPanel header must show v0.4.1");
assert(searchPanel.includes("visual-research-board-library-v0.4.1.json"), "library export filename must use v0.4.1");

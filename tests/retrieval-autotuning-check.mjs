...
assert(searchPanel.includes("visual-research-board-library-v0.2.4.json"), "library export filename must use v0.2.4");

const docs = read("docs/retrieval-weak-case-auto-tuning.md");
assert(docs.includes("v0.2.4"), "auto-tuning docs must identify v0.2.4");
...
console.log("Retrieval auto-tuning checks passed for v0.2.4.");

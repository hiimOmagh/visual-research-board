...
for (const file of requiredFiles) assert(existsSync(join(root, file)), `Missing v0.2.10 file: ${file}`);
...
assert(docs.includes("v0.2.10"), "v0.2.10 docs must identify the version");
...
console.log("Free image retrieval + Reference Search Hub checks passed for v0.2.10.");

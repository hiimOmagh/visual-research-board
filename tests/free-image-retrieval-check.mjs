...
for (const file of requiredFiles) assert(existsSync(join(root, file)), `Missing v0.2.9 file: ${file}`);
...
assert(searchPanel.includes("visual-research-board-library-v0.2.9.json"), "library export filename must use v0.2.9");
...
assert(docs.includes("v0.2.9"), "v0.2.9 docs must identify the version");
...
console.log("Free image retrieval + Reference Search Hub checks passed for v0.2.9.");

...
assert(searchPanel.includes("v0.3.2"), "SearchPanel header must show v0.3.2");
assert(searchPanel.includes("visual-research-board-library-v0.3.2.json"), "library export filename must use v0.3.2");

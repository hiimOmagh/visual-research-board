...
assert(runtimeLib.includes("APP_VERSION = \"0.8.1\""), "provider runtime report must expose app version 0.8.1");
...
console.log("Provider runtime pack checks passed for v0.8.1.");

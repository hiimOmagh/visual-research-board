...
assert(runtimeLib.includes("APP_VERSION = \"0.9.0\""), "provider runtime report must expose app version 0.9.0");
...
console.log("Provider runtime pack checks passed for v0.9.0.");

...
assert(runtimeLib.includes("APP_VERSION = \"0.3.0\""), "provider runtime report must expose app version 0.3.0");
...
console.log("Provider runtime pack checks passed for v0.3.0.");

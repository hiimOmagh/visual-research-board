...
assert(runtimeLib.includes("APP_VERSION = \"2.0.5\""), "provider runtime report must expose app version 2.0.5");
...
console.log("Provider runtime pack checks passed for v2.0.5.");

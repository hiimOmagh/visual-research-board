...
assert(runtimeLib.includes("APP_VERSION = \"0.8.2\""), "provider runtime report must expose app version 0.8.2");
...
console.log("Provider runtime pack checks passed for v0.8.2.");

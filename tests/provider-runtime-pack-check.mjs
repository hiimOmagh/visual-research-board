...
assert(runtimeLib.includes("APP_VERSION = \"1.7.0\""), "provider runtime report must expose app version 1.7.0");
...
console.log("Provider runtime pack checks passed for v1.7.0.");

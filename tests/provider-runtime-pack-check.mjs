...
assert(runtimeLib.includes("APP_VERSION = \"0.2.6\""), "provider runtime report must expose app version 0.2.6");
...
console.log("Provider runtime pack checks passed for v0.2.6.");

...
assert(runtimeLib.includes("APP_VERSION = \"1.8.0\""), "provider runtime report must expose app version 1.8.0");
...
console.log("Provider runtime pack checks passed for v1.8.0.");

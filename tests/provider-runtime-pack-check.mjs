...
assert(runtimeLib.includes("APP_VERSION = \"1.2.0\""), "provider runtime report must expose app version 1.2.0");
...
console.log("Provider runtime pack checks passed for v1.2.0.");

...
assert(runtimeLib.includes("APP_VERSION = \"1.9.0\""), "provider runtime report must expose app version 1.9.0");
...
console.log("Provider runtime pack checks passed for v1.9.0.");

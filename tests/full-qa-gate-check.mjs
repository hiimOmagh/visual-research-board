...
assert(pkg.version === "2.0.5", "package.json version must be 2.0.5");
...
assert(fullGate.includes('schema_version: "2.0.5"'), "full QA gate report schema must identify v2.0.5");
...
for (const token of ["v2.0.5", "npm run qa", "npm run qa:list", "qa:baseline", "qa:retrieval", "qa:providers", "qa:security", "qa:public-demo", "qa:workflow", "qa:exports", "qa:release", "artifacts/full-qa-gate-report.json"]) {
...
assert(release.includes("v2.0.5"), "release checklist must identify v2.0.5");
...
assert(validation.includes("Visual Research Board v2.0.5"), "validation report must identify v2.0.5");
...
assert(readme.includes("Visual Research Board v2.0.5"), "README must identify v2.0.5");
...
assert(manifest.includes("v2.0.5"), "PATCH_MANIFEST must identify v2.0.5");
...
console.log("Full QA Gate checks passed for v2.0.5.");

...
assert(fullGate.includes('schema_version: "2.0.2"'), "full QA gate report schema must identify v2.0.2");
...
for (const token of ["v2.0.2", "npm run qa", "npm run qa:list", "qa:baseline", "qa:retrieval", "qa:providers", "qa:security", "qa:public-demo", "qa:workflow", "qa:exports", "qa:release", "artifacts/full-qa-gate-report.json"]) {
...
assert(release.includes("v2.0.2"), "release checklist must identify v2.0.2");
...
assert(validation.includes("Visual Research Board v2.0.2"), "validation report must identify v2.0.2");
...
assert(readme.includes("Visual Research Board v2.0.2"), "README must identify v2.0.2");
...
assert(manifest.includes("v2.0.2"), "PATCH_MANIFEST must identify v2.0.2");
...
console.log("Full QA Gate checks passed for v2.0.2.");

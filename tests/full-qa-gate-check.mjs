...
assert(fullGate.includes('schema_version: "2.4.0"'), "full QA gate report schema must identify v2.4.0");
...
for (const token of ["v2.4.0", "npm run qa", "npm run qa:list", "qa:baseline", "qa:retrieval", "qa:providers", "qa:security", "qa:public-demo", "qa:workflow", "qa:exports", "qa:release", "artifacts/full-qa-gate-report.json"]) {
...
assert(release.includes("v2.4.0"), "release checklist must identify v2.4.0");
...
assert(validation.includes("Visual Research Board v2.4.0"), "validation report must identify v2.4.0");
...
assert(readme.includes("Visual Research Board v2.4.0"), "README must identify v2.4.0");
...
assert(manifest.includes("v2.4.0"), "PATCH_MANIFEST must identify v2.4.0");
...
console.log("Full QA Gate checks passed for v2.4.0.");

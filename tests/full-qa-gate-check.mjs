...
assert(fullGate.includes('schema_version: "2.1.3"'), "full QA gate report schema must identify v2.1.3");
...
for (const token of ["v2.1.3", "npm run qa", "npm run qa:list", "qa:baseline", "qa:retrieval", "qa:providers", "qa:security", "qa:public-demo", "qa:workflow", "qa:exports", "qa:release", "artifacts/full-qa-gate-report.json"]) {
...
assert(release.includes("v2.1.3"), "release checklist must identify v2.1.3");
...
assert(validation.includes("Visual Research Board v2.1.3"), "validation report must identify v2.1.3");
...
assert(readme.includes("Visual Research Board v2.1.3"), "README must identify v2.1.3");
...
assert(manifest.includes("v2.1.3"), "PATCH_MANIFEST must identify v2.1.3");
...
console.log("Full QA Gate checks passed for v2.1.3.");

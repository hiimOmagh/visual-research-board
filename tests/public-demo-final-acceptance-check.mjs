...
assert(VERSION === "0.9.0", "package.json version must be 0.9.0");
...
assert(readme.includes("v0.9.0"), "README must mention v0.9.0");
...
assert(finalDoc.includes("v0.9.0"), "final acceptance doc must mention v0.9.0");

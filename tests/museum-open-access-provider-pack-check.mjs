...
for (const token of ["v2.1.4", "Met Museum", "Art Institute of Chicago", "Cleveland Museum", "Wellcome Collection", "Biodiversity Heritage Library", "Gallica", "NARA", "npm run museum:providers:check"]) {
...
console.log("Museum/Open-Access Provider Pack checks passed for v2.1.4.");
process.exit(0);

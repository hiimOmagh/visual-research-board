...
if (!fs.existsSync(packageJsonPath)) {
  ...
  assert(packageJson.version === "0.8.0", `package.json version must be 0.8.0, got ${packageJson.version}`);
...
if (exists("scripts/full-qa-gate.mjs")) {
  ...
  assertIncludes(fullQaGate, "0.8.0", "scripts/full-qa-gate.mjs");
...
if (exists("tests/full-qa-gate-check.mjs")) {
  ...
  assertIncludes(fullQaGateCheck, "0.8.0", "tests/full-qa-gate-check.mjs");
}
...
assertIncludes(readme, "v0.8.0", "README.md");
...
console.log("Public demo release-candidate check passed for v0.8.0.");

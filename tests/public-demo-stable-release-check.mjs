...
assert(readme.includes("v2.0.5"), "README must mention v2.0.5");
...
assert(stableDoc.includes("v2.0.5"), "stable release doc must mention v2.0.5");
...
assert(checklist.includes("v2.0.5"), "stable checklist must mention v2.0.5");

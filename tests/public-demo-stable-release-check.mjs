...
assert(readme.includes("v1.8.0"), "README must mention v1.8.0");
...
assert(stableDoc.includes("v1.8.0"), "stable release doc must mention v1.8.0");
...
assert(checklist.includes("v1.8.0"), "stable checklist must mention v1.8.0");

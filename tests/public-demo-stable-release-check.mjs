...
assert(VERSION === "1.0.0", "package.json version must be 1.0.0");
...
assert(readme.includes("v1.0.0"), "README must mention v1.0.0");
...
assert(stableDoc.includes("v1.0.0"), "stable release doc must mention v1.0.0");
...
assert(checklist.includes("v1.0.0"), "stable checklist must mention v1.0.0");

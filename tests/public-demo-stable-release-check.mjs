...
assert(readme.includes("v2.1.3"), "README must mention v2.1.3");
...
assert(stableDoc.includes("v2.1.3"), "stable release doc must mention v2.1.3");
...
assert(checklist.includes("v2.1.3"), "stable checklist must mention v2.1.3");

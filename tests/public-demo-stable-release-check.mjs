...
assert(readme.includes("v2.2.0"), "README must mention v2.2.0");
...
assert(stableDoc.includes("v2.2.0"), "stable release doc must mention v2.2.0");
...
assert(checklist.includes("v2.2.0"), "stable checklist must mention v2.2.0");

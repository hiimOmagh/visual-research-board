...
assert(readme.includes("v2.0.1"), "README must mention v2.0.1");
...
assert(stableDoc.includes("v2.0.1"), "stable release doc must mention v2.0.1");
...
assert(checklist.includes("v2.0.1"), "stable checklist must mention v2.0.1");

...
assert(readme.includes("v2.0.2"), "README must mention v2.0.2");
...
assert(stableDoc.includes("v2.0.2"), "stable release doc must mention v2.0.2");
...
assert(checklist.includes("v2.0.2"), "stable checklist must mention v2.0.2");

...
assert(readme.includes("v2.1.4"), "README must mention v2.1.4");
...
assert(stableDoc.includes("v2.1.4"), "stable release doc must mention v2.1.4");
...
assert(checklist.includes("v2.1.4"), "stable checklist must mention v2.1.4");

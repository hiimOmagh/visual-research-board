...
assert(types.includes('schema_version: "0.2.9"'), "review feedback schema must be versioned as 0.2.9");
...
assert(docs.includes("v0.2.9"), "docs must identify v0.2.9");
...
console.log("Review-evidence feedback checks passed for v0.2.9.");

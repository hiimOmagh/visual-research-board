...
assert(types.includes('schema_version: "0.2.8"'), "review feedback schema must be versioned as 0.2.8");
...
assert(searchPanel.includes("visual-research-board-library-v0.2.8.json"), "library export filename must use v0.2.8");
...
assert(docs.includes("v0.2.8"), "docs must identify v0.2.8");
...
console.log("Review-evidence feedback checks passed for v0.2.8.");

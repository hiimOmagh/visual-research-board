...
assert(VERSION === "1.3.0", "package.json version must be 1.3.0");
...
assert(!lockText.includes('"is-finalizationregistry": "^1.3.0"'), "lockfile must not mutate is-finalizationregistry dependency to app version");
assert(!lockText.includes('"which-boxed-primitive": "^1.3.0"'), "lockfile must not mutate which-boxed-primitive dependency to app version");

...
assert(fullQaGate.includes("2.1.5"), "Full QA gate must reference v2.1.5");
...
assert(hostedDemoDoc.includes("v2.1.5"), "hosted demo evidence review doc must reference v2.1.5");
...
console.log("Hosted Demo Evidence Review checks passed for v2.1.5.");

...
assert(hostedDemoDoc.includes("v2.0.3"), "hosted demo evidence review doc must reference v2.0.3");
...
console.log("Hosted Demo Evidence Review checks passed for v2.0.3.");

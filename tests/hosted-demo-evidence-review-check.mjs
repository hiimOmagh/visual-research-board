...
assert(fullQaGate.includes("2.0.5"), "Full QA gate must reference v2.0.5");
...
assert(hostedDemoDoc.includes("v2.0.5"), "hosted demo evidence review doc must reference v2.0.5");
...
console.log("Hosted Demo Evidence Review checks passed for v2.0.5.");

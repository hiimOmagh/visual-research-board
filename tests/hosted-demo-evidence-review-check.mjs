...
assert(fullQaGate.includes("1.7.0"), "Full QA gate must reference v1.7.0");
...
assert(hostedDemoDoc.includes("v1.7.0"), "hosted demo evidence review doc must reference v1.7.0");
...
console.log("Hosted Demo Evidence Review checks passed for v1.7.0.");

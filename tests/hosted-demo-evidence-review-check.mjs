...
assert(fullQaGate.includes("2.1.1"), "Full QA gate must reference v2.1.1");
...
assert(hostedDemoDoc.includes("v2.1.1"), "hosted demo evidence review doc must reference v2.1.1");
...
console.log("Hosted Demo Evidence Review checks passed for v2.1.1.");

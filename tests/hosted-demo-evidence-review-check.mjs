...
assert(hostedDemoDoc.includes("v1.5.0"), "hosted demo evidence review doc must reference v1.5.0");
...
console.log("Hosted Demo Evidence Review checks passed for v1.5.0.");

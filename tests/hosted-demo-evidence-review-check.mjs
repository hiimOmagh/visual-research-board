...
assert(fullQaGate.includes("1.2.0"), "Full QA gate must reference v1.2.0");
...
assert(hostedDemoDoc.includes("v1.2.0"), "hosted demo evidence review doc must reference v1.2.0");
...
console.log("Hosted Demo Evidence Review checks passed for v1.2.0.");

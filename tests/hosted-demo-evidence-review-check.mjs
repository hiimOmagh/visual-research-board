...
assert(fullQaGate.includes("2.0.0"), "Full QA gate must reference v2.0.0");
...
assert(hostedDemoDoc.includes("v2.0.0"), "hosted demo evidence review doc must reference v2.0.0");
...
console.log("Hosted Demo Evidence Review checks passed for v2.0.0.");

...
assert(fullQaGate.includes(VERSION), "Full QA gate must reference v0.8.2");

const fullQaGateCheck = read("tests/full-qa-gate-check.mjs");
assert(fullQaGateCheck.includes(VERSION), "Full QA gate manifest check must reference v0.8.2");
...
console.log("Public Demo Evidence Lock checks passed for v0.8.2.");

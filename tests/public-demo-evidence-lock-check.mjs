...
assert(fullQaGate.includes(VERSION), "Full QA gate must reference v1.9.0");

const fullQaGateCheck = read("tests/full-qa-gate-check.mjs");
assert(fullQaGateCheck.includes(VERSION), "Full QA gate manifest check must reference v1.9.0");
...
console.log("Public Demo Evidence Lock checks passed for v1.9.0.");

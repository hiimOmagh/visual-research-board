...
assert(fullQaGate.includes(VERSION), "Full QA gate must reference v2.1.0");

const fullQaGateCheck = read("tests/full-qa-gate-check.mjs");
assert(fullQaGateCheck.includes(VERSION), "Full QA gate manifest check must reference v2.1.0");
...
console.log("Public Demo Evidence Lock checks passed for v2.1.0.");

...
const fixture = JSON.parse(readFileSync(join(root, "tests/fixtures/provider-smoke-stable.json"), "utf8"));
const failures = [];
...
console.log("Provider smoke fixture checks passed for v0.2.10.");

...
const fixture = JSON.parse(readFileSync(join(root, "tests/fixtures/provider-smoke-alpha10.json"), "utf8"));
const failures = [];
...
console.log("Provider smoke fixture checks passed for v0.1.0-alpha.10.");

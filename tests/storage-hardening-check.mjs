...
for (const token of [
  ...
  "visual-research-board-backup-v0.8.2.json",
...
assert(lock.includes('"version": "0.8.2"'), "package-lock.json must use version 0.8.2");
...
console.log("Local Storage + Import/Export Hardening checks passed for v0.8.2.");
process.exit(0);

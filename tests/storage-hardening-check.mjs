...
for (const token of [
  ...
  "visual-research-board-backup-v0.7.0.json",
...
assert(lock.includes('"version": "0.7.0"'), "package-lock.json must use version 0.7.0");
...
console.log("Local Storage + Import/Export Hardening checks passed for v0.7.0.");
process.exit(0);

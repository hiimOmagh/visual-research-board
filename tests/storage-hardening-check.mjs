...
for (const token of [
  ...
  "visual-research-board-backup-v2.0.1.json",
...
assert(lock.includes('"version": "2.0.1"'), "package-lock.json must use version 2.0.1");
...
console.log("Local Storage + Import/Export Hardening checks passed for v2.0.1.");
process.exit(0);

...
for (const token of [
  ...
  "visual-research-board-backup-v2.1.7.json",
...
assert(lock.includes('"version": "2.1.7"'), "package-lock.json must use version 2.1.7");
...
console.log("Local Storage + Import/Export Hardening checks passed for v2.1.7.");
process.exit(0);

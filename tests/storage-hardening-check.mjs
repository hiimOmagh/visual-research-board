...
for (const token of [
  ...
  "visual-research-board-backup-v0.7.1.json",
...
assert(lock.includes('"version": "0.7.1"'), "package-lock.json must use version 0.7.1");
...
console.log("Local Storage + Import/Export Hardening checks passed for v0.7.1.");
process.exit(0);

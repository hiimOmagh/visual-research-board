...
for (const token of [
  ...
  "visual-research-board-backup-v0.9.0.json",
...
assert(lock.includes('"version": "0.9.0"'), "package-lock.json must use version 0.9.0");
...
console.log("Local Storage + Import/Export Hardening checks passed for v0.9.0.");
process.exit(0);

...
for (const token of [
  ...
  "visual-research-board-backup-v2.1.11.json",
...
assert(lock.includes('"version": "2.1.11"'), "package-lock.json must use version 2.1.11");
...
console.log("Local Storage + Import/Export Hardening checks passed for v2.1.11.");
process.exit(0);

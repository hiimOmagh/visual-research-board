...
for (const token of [
  ...
  "visual-research-board-backup-v2.1.4.json",
...
assert(lock.includes('"version": "2.1.4"'), "package-lock.json must use version 2.1.4");
...
console.log("Local Storage + Import/Export Hardening checks passed for v2.1.4.");
process.exit(0);

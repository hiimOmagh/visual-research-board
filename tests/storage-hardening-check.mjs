...
for (const token of [
  ...
  "visual-research-board-backup-v0.8.3.json",
...
assert(lock.includes('"version": "0.8.3"'), "package-lock.json must use version 0.8.3");
...
console.log("Local Storage + Import/Export Hardening checks passed for v0.8.3.");
process.exit(0);

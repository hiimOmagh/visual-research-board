...
for (const token of [
  ...
  "visual-research-board-backup-v2.3.0.json",
...
assert(lock.includes('"version": "2.3.0"'), "package-lock.json must use version 2.3.0");
...
console.log("Local Storage + Import/Export Hardening checks passed for v2.3.0.");
process.exit(0);

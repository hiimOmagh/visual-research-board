...
for (const token of [
  ...
  "visual-research-board-backup-v1.9.0.json",
...
assert(lock.includes('"version": "1.9.0"'), "package-lock.json must use version 1.9.0");
...
console.log("Local Storage + Import/Export Hardening checks passed for v1.9.0.");
process.exit(0);

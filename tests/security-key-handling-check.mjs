...
assert(fullGate.includes('schema_version: "1.1.0"'), "full QA report schema must identify v1.1.0");

const docs = read("docs/security-and-key-handling.md");
for (const token of ["v1.1.0", "server-only", "redacted", "NEXT_PUBLIC", "npm run security:key:check", "Reference Search Hub"]) {
...
console.log("Security and Key Handling checks passed for v1.1.0.");

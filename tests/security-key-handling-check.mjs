...
assert(fullGate.includes('schema_version: "0.8.0"'), "full QA report schema must identify v0.8.0");

const docs = read("docs/security-and-key-handling.md");
for (const token of ["v0.8.0", "server-only", "redacted", "NEXT_PUBLIC", "npm run security:key:check", "Reference Search Hub"]) {
...
console.log("Security and Key Handling checks passed for v0.8.0.");

...
assert(lib.includes('CREATOR_WORKFLOW_VERSION = "2.4.0"'), "creator workflow lib must expose v2.4.0");
...
assert(readme.includes("End-to-End Creator Research Workflow MVP"), "README must mention the v2.4.0 workflow MVP");
...
console.log("End-to-End Creator Research Workflow MVP checks passed for v2.4.0.");

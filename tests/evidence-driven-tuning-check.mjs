...
assert(searchPanel.includes("visual-research-board-library-v0.2.7.json"), "library export filename must use v0.2.7");
...
assert(docs.includes("v0.2.7"), "evidence tuning docs must identify v0.2.7");
...
console.log("Evidence-driven tuning checks passed for v0.2.7.");

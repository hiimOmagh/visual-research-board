...
const fixture = JSON.parse(readFileSync(join(root, "tests/fixtures/normalization-alpha9.json"), "utf8"));
...
console.log("Normalization checks passed for v0.1.0-alpha.9.");

# v2.0.0 — Reference Workflow Stable Release Patch Manifest

## Scope

v2.0.0 stabilizes the full discovery → board → activation → export workflow.
...
# v2.0.0 — Activation Pack Export Integration Patch Manifest

## Scope

v2.0.0 connects activation pack Markdown/JSON preview output to existing text download utilities.
...
# v2.0.0 — Activation Pack Export Preview Patch Manifest

## Scope

v2.0.0 adds preview-only Markdown/JSON rendering for activation packs.
...
# v2.0.0 — Activation Pack UI Integration Patch Manifest

## Scope

v2.0.0 wires activation packs into a visible board workflow panel using already-gathered references.
...
# v2.0.0 — Reference Activation Pack MVP Patch Manifest

## Scope

v2.0.0 adds activation-ready reference packs built from already-gathered board/reference data.
...
# v2.0.0 — Book / Bibliographic Discovery Layer Patch Manifest

## Scope

v2.0.0 adds metadata-first book and bibliographic discovery planning and classification.
...
# v2.0.0 — Social Reference Discovery Layer Patch Manifest

## Scope

v2.0.0 adds public social-reference discovery planning and classification.
...
# v2.0.0 — Broad Web + Image Discovery Expansion Patch Manifest

## Scope

v2.0.0 adds broad web/image discovery planning and candidate normalization.
...
# v2.0.0 — Broad Reference Result Model Patch Manifest

## Scope

v2.0.0 adds the Broad Reference Result Model.
...
# v2.0.0 — Reference Intelligence Layer MVP Patch Manifest

## Scope

v2.0.0 adds the Reference Intelligence Layer MVP.
...
# v2.0.0 — Public Demo Stable Release Patch Manifest

## Scope

v2.0.0 locks the public demo stable release.
...
# v2.0.0 — Public Demo Final Acceptance Patch Manifest

## Scope

v2.0.0 finalizes public-demo acceptance before stable release.
...
# v2.0.0 — Hosted Demo Evidence Review Patch Manifest

## Scope

v2.0.0 adds a hosted-demo evidence-review gate and documentation while preserving the v2.0.0 Public Demo Evidence Lock.
...
# v2.0.0 — Public Demo Evidence Lock Patch Manifest
...
v2.0.0 locks public-demo release evidence without changing product behavior.
...
# v2.0.0 — Public Demo Release Candidate Patch Manifest
...
v2.0.0 prepares the app as a Public Demo Release Candidate while preserving the v2.0.0 Security and Key Handling layer.
...
# v2.0.0 — Security and Key Handling Patch Manifest
...
- v2.0.0 — UX Reliability + Empty State Polish
- v2.0.0 — Local Storage + Import/Export Hardening

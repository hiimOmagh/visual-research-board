# v2.4.0 — Verification Artifact Schema Lock + Release Evidence Index Patch Manifest

## Scope

v2.4.0 adds a verification artifact schema lock and generated release evidence index.
...
# v2.4.0 — Verification Report Freshness Lock + Warning Suppression Patch Manifest

## Scope

v2.4.0 adds a verification report freshness lock and stale warning suppression.
...
# v2.4.0 — CI Parity Workflow Badge + Verification Docs Lock Patch Manifest
...
# v2.4.0 — Single-Command Verification UX + Release Command Compression Patch Manifest

## Scope

v2.4.0 formalizes the compressed verification command model.
...
# v2.4.0 — First-Run Demo Script + Public Walkthrough Copy Patch Manifest

## Scope

v2.4.0 adds first-run demo narration and public walkthrough copy after the evidence artifact review milestone.
...
# v2.4.0 — First-Run Evidence Artifact Review + Demo Capture Notes Patch Manifest

## Scope

v2.4.0 adds a first-run evidence artifact review layer and demo capture notes after the responsive screenshot evidence milestone.
...
# v2.4.0 — First-Run Visual QA + Responsive Screenshot Evidence Patch Manifest

## Scope

v2.4.0 adds first-run visual QA and responsive screenshot evidence planning after the controlled first-run panel mount.
...
# v2.4.0 — Controlled First-Run Panel Mount + UI Consistency Patch Manifest

## Scope

v2.4.0 safely mounts the first-run workflow panel in the SearchPanel UI.
...
# v2.4.0 — First-Run UX + Workflow Clarity Patch Manifest

## Scope

v2.4.0 improves first-run workflow clarity after the v2.0.x release automation baseline.
...
# v2.4.0 — Unified Release Verification Runner Patch Manifest

## Scope

v2.4.0 adds a unified release verification runner for local and CI parity.
...
# v2.4.0 — Release Package Audit Patch Manifest

## Scope

v2.4.0 audits release package integrity after the public demo screenshot/evidence lock.
...
# v2.4.0 — Public Demo Evidence + Screenshot Lock Patch Manifest

## Scope

v2.4.0 locks public demo screenshot/evidence requirements for the stable v2 workflow.
...
# v2.4.0 — Dependency Audit Triage Patch Manifest

## Scope

v2.4.0 triages the 2 moderate npm audit warnings without force-fixing or dependency churn.
...
# v2.4.0 — Stable Release Hygiene + Audit Warning Review Patch Manifest
...
# v2.4.0 — Reference Workflow Stable Release Patch Manifest

## Scope

v2.4.0 stabilizes the full discovery → board → activation → export workflow.
...
# v2.4.0 — Activation Pack Export Integration Patch Manifest

## Scope

v2.4.0 connects activation pack Markdown/JSON preview output to existing text download utilities.
...
# v2.4.0 — Activation Pack Export Preview Patch Manifest

## Scope

v2.4.0 adds preview-only Markdown/JSON rendering for activation packs.
...
# v2.4.0 — Activation Pack UI Integration Patch Manifest

## Scope

v2.4.0 wires activation packs into a visible board workflow panel using already-gathered references.
...
# v2.4.0 — Reference Activation Pack MVP Patch Manifest

## Scope

v2.4.0 adds activation-ready reference packs built from already-gathered board/reference data.
...
# v2.4.0 — Book / Bibliographic Discovery Layer Patch Manifest

## Scope

v2.4.0 adds metadata-first book and bibliographic discovery planning and classification.
...
# v2.4.0 — Social Reference Discovery Layer Patch Manifest

## Scope

v2.4.0 adds public social-reference discovery planning and classification.
...
# v2.4.0 — Broad Web + Image Discovery Expansion Patch Manifest

## Scope

v2.4.0 adds broad web/image discovery planning and candidate normalization.
...
# v2.4.0 — Broad Reference Result Model Patch Manifest

## Scope

v2.4.0 adds the Broad Reference Result Model.
...
# v2.4.0 — Reference Intelligence Layer MVP Patch Manifest

## Scope

v2.4.0 adds the Reference Intelligence Layer MVP.
...
# v2.4.0 — Public Demo Stable Release Patch Manifest

## Scope

v2.4.0 locks the public demo stable release.
...
# v2.4.0 — Public Demo Final Acceptance Patch Manifest

## Scope

v2.4.0 finalizes public-demo acceptance before stable release.
...
# v2.4.0 — Hosted Demo Evidence Review Patch Manifest

## Scope

v2.4.0 adds a hosted-demo evidence-review gate and documentation while preserving the v2.4.0 Public Demo Evidence Lock.
...
# v2.4.0 — Public Demo Evidence Lock Patch Manifest
...
v2.4.0 locks public-demo release evidence without changing product behavior.
...
# v2.4.0 — Public Demo Release Candidate Patch Manifest
...
v2.4.0 prepares the app as a Public Demo Release Candidate while preserving the v2.4.0 Security and Key Handling layer.
...
# v2.4.0 — Security and Key Handling Patch Manifest
...
- v2.4.0 — UX Reliability + Empty State Polish
- v2.4.0 — Local Storage + Import/Export Hardening
...
## v2.4.0 — Nested Verification Warning Silence + Final Freshness Recheck
...
## v2.4.0 — Dependency Audit Resolution + Safe Upgrade Lock
...
- Updated package metadata and documentation to v2.4.0.

## v2.4.0 — Route Surface Integrity + Creator Workflow Landing Integration

- Added route surface integrity checker.
- Added route surface review artifact.
- Restored landing page visibility for `/`.
- Preserved `/creator-workflow` as the main creator research workflow path.
- Ensured expected local-first API route handlers exist.
- Added full QA gate coverage without adding packaging or release archive work.

## v2.4.0 - Evidence Pack Export v2 + Usable Creator Output

- Added local-first Evidence Pack v2 builder.
- Added creator workflow export preview with Markdown/JSON copy and download actions.
- Added Carthage demo export scenario with missing coverage and fixture/demo disclosure.
- Added Evidence Pack v2 QA gate.

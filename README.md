...
v2.0.2 does not add another product feature. It hardens the release process with a consolidated **Security and Key Handling**.
...
v2.0.2 is a validation-hardening release. A successful release needs:
...
The current app version is v2.0.2. Some retained evidence docs and fixture gates still identify v0.3.1 because they validate historical provider/runtime and real-topic evidence behavior that remains active.
...
The current target is **v2.0.2 — Public Demo Release Candidate**.
...
The current target is **v2.0.2 — Public Demo Evidence Lock**.
...
The current target is **v2.0.2 — Hosted Demo Evidence Review**.
...
The current target is **v2.0.2 — Public Demo Final Acceptance**.
...
The current release is **v2.0.2 — Public Demo Stable Release**.
...
The current release is **v2.0.2 — Reference Intelligence Layer MVP**.
...
The current release is **v2.0.2 — Broad Reference Result Model**.
...
The current release is **v2.0.2 — Broad Web + Image Discovery Expansion**.
...
The current release is **v2.0.2 — Social Reference Discovery Layer**.
...
The current release is **v2.0.2 — Book / Bibliographic Discovery Layer**.
...
The current release is **v2.0.2 — Reference Activation Pack MVP**.
...
The current release is **v2.0.2 — Activation Pack UI Integration**.
...
The current release is **v2.0.2 — Activation Pack Export Preview**.
...
The current release is **v2.0.2 — Activation Pack Export Integration**.
...
The current release is **v2.0.2 — Reference Workflow Stable Release**.
...
The current release is **v2.0.2 — Stable Release Hygiene + Audit Warning Review**.
...
The current release is **v2.0.2 — Dependency Audit Triage**.

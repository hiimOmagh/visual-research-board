[![CI Parity](https://github.com/hiimOmagh/visual-research-board/actions/workflows/ci-parity.yml/badge.svg)](https://github.com/hiimOmagh/visual-research-board/actions/workflows/ci-parity.yml)

# Visual Research Board v2.1.7
...
v2.1.7 does not add another product feature. It hardens the release process with a consolidated **Security and Key Handling**.
...
v2.1.7 is a validation-hardening release. A successful release needs:
...
The current app version is v2.1.7. Some retained evidence docs and fixture gates still identify v0.3.1 because they validate historical provider/runtime and real-topic evidence behavior that remains active.
...
The current target is **v2.1.7 — Public Demo Release Candidate**.
...
The current target is **v2.1.7 — Public Demo Evidence Lock**.
...
The current target is **v2.1.7 — Hosted Demo Evidence Review**.
...
The current target is **v2.1.7 — Public Demo Final Acceptance**.
...
The current release is **v2.1.7 — Public Demo Stable Release**.
...
The current release is **v2.1.7 — Reference Intelligence Layer MVP**.
...
The current release is **v2.1.7 — Broad Reference Result Model**.
...
The current release is **v2.1.7 — Broad Web + Image Discovery Expansion**.
...
The current release is **v2.1.7 — Social Reference Discovery Layer**.
...
The current release is **v2.1.7 — Book / Bibliographic Discovery Layer**.
...
The current release is **v2.1.7 — Reference Activation Pack MVP**.
...
The current release is **v2.1.7 — Activation Pack UI Integration**.
...
The current release is **v2.1.7 — Activation Pack Export Preview**.
...
The current release is **v2.1.7 — Activation Pack Export Integration**.
...
The current release is **v2.1.7 — Reference Workflow Stable Release**.
...
The current release is **v2.1.7 — Stable Release Hygiene + Audit Warning Review**.
...
The current release is **v2.1.7 — Dependency Audit Triage**.
...
The current release is **v2.1.7 — Public Demo Evidence + Screenshot Lock**.
...
The current release is **v2.1.7 — Release Package Audit**.
...
The current release is **v2.1.7 — Unified Release Verification Runner**.
...
The current release is **v2.1.7 — First-Run UX + Workflow Clarity**.
...
The current release is **v2.1.7 — Controlled First-Run Panel Mount + UI Consistency**.
...
The current release is **v2.1.7 — First-Run Visual QA + Responsive Screenshot Evidence**.
...
The current release is **v2.1.7 — First-Run Evidence Artifact Review + Demo Capture Notes**.
...
## First-Run Demo Script + Public Walkthrough Copy

The current release is **v2.1.7 — First-Run Demo Script + Public Walkthrough Copy**.

This patch adds a public-safe first-run demo script and walkthrough copy.
...
## Single-Command Verification UX + Release Command Compression

The current release is **v2.1.7 — Single-Command Verification UX + Release Command Compression**.
...
Debug-only commands remain available, but the default path is now one command.

## CI Parity Workflow Badge + Verification Docs Lock

The current release is **v2.1.7 — CI Parity Workflow Badge + Verification Docs Lock**.
...
## Verification Report Freshness Lock + Warning Suppression

The current release is **v2.1.7 — Verification Report Freshness Lock + Warning Suppression**.
...
The release verifier suppresses stale report warnings while it regenerates the current verification artifacts. Real failing gates remain fatal.

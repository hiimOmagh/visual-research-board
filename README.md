...
v2.1.5 does not add another product feature. It hardens the release process with a consolidated **Security and Key Handling**.
...
v2.1.5 is a validation-hardening release. A successful release needs:
...
The current app version is v2.1.5. Some retained evidence docs and fixture gates still identify v0.3.1 because they validate historical provider/runtime and real-topic evidence behavior that remains active.
...
The current target is **v2.1.5 — Public Demo Release Candidate**.
...
The current target is **v2.1.5 — Public Demo Evidence Lock**.
...
The current target is **v2.1.5 — Hosted Demo Evidence Review**.
...
The current target is **v2.1.5 — Public Demo Final Acceptance**.
...
The current release is **v2.1.5 — Public Demo Stable Release**.
...
The current release is **v2.1.5 — Reference Intelligence Layer MVP**.
...
The current release is **v2.1.5 — Broad Reference Result Model**.
...
The current release is **v2.1.5 — Broad Web + Image Discovery Expansion**.
...
The current release is **v2.1.5 — Social Reference Discovery Layer**.
...
The current release is **v2.1.5 — Book / Bibliographic Discovery Layer**.
...
The current release is **v2.1.5 — Reference Activation Pack MVP**.
...
The current release is **v2.1.5 — Activation Pack UI Integration**.
...
The current release is **v2.1.5 — Activation Pack Export Preview**.
...
The current release is **v2.1.5 — Activation Pack Export Integration**.
...
The current release is **v2.1.5 — Reference Workflow Stable Release**.
...
The current release is **v2.1.5 — Stable Release Hygiene + Audit Warning Review**.
...
The current release is **v2.1.5 — Dependency Audit Triage**.
...
The current release is **v2.1.5 — Public Demo Evidence + Screenshot Lock**.
...
The current release is **v2.1.5 — Release Package Audit**.
...
The current release is **v2.1.5 — Unified Release Verification Runner**.
...
The current release is **v2.1.5 — First-Run UX + Workflow Clarity**.
...
The current release is **v2.1.5 — Controlled First-Run Panel Mount + UI Consistency**.
...
The current release is **v2.1.5 — First-Run Visual QA + Responsive Screenshot Evidence**.
...
The current release is **v2.1.5 — First-Run Evidence Artifact Review + Demo Capture Notes**.
...
The current release is **v2.1.5 — First-Run Demo Script + Public Walkthrough Copy**.
...
The current release is **v2.1.5 — Single-Command Verification UX + Release Command Compression**.

...
v2.1.1 does not add another product feature. It hardens the release process with a consolidated **Security and Key Handling**.
...
v2.1.1 is a validation-hardening release. A successful release needs:
...
The current app version is v2.1.1. Some retained evidence docs and fixture gates still identify v0.3.1 because they validate historical provider/runtime and real-topic evidence behavior that remains active.
...
The current target is **v2.1.1 — Public Demo Release Candidate**.
...
The current target is **v2.1.1 — Public Demo Evidence Lock**.
...
The current target is **v2.1.1 — Hosted Demo Evidence Review**.
...
The current target is **v2.1.1 — Public Demo Final Acceptance**.
...
The current release is **v2.1.1 — Public Demo Stable Release**.
...
The current release is **v2.1.1 — Reference Intelligence Layer MVP**.
...
The current release is **v2.1.1 — Broad Reference Result Model**.
...
The current release is **v2.1.1 — Broad Web + Image Discovery Expansion**.
...
The current release is **v2.1.1 — Social Reference Discovery Layer**.
...
The current release is **v2.1.1 — Book / Bibliographic Discovery Layer**.
...
The current release is **v2.1.1 — Reference Activation Pack MVP**.
...
The current release is **v2.1.1 — Activation Pack UI Integration**.
...
The current release is **v2.1.1 — Activation Pack Export Preview**.
...
The current release is **v2.1.1 — Activation Pack Export Integration**.
...
The current release is **v2.1.1 — Reference Workflow Stable Release**.
...
The current release is **v2.1.1 — Stable Release Hygiene + Audit Warning Review**.
...
The current release is **v2.1.1 — Dependency Audit Triage**.
...
The current release is **v2.1.1 — Public Demo Evidence + Screenshot Lock**.
...
The current release is **v2.1.1 — Release Package Audit**.
...
The current release is **v2.1.1 — Unified Release Verification Runner**.
...
The current release is **v2.1.1 — First-Run UX + Workflow Clarity**.
...
The current release is **v2.1.1 — Controlled First-Run Panel Mount + UI Consistency**.

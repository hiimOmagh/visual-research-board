...
v1.7.0 does not add another product feature. It hardens the release process with a consolidated **Security and Key Handling**.
...
v1.7.0 is a validation-hardening release. A successful release needs:
...
The current app version is v1.7.0. Some retained evidence docs and fixture gates still identify v0.3.1 because they validate historical provider/runtime and real-topic evidence behavior that remains active.
...
The current target is **v1.7.0 — Public Demo Release Candidate**.
...
The current target is **v1.7.0 — Public Demo Evidence Lock**.
...
The current target is **v1.7.0 — Hosted Demo Evidence Review**.
...
The current target is **v1.7.0 — Public Demo Final Acceptance**.
...
The current release is **v1.7.0 — Public Demo Stable Release**.
...
The current release is **v1.7.0 — Reference Intelligence Layer MVP**.
...
The current release is **v1.7.0 — Broad Reference Result Model**.
...
The current release is **v1.7.0 — Broad Web + Image Discovery Expansion**.
...
The current release is **v1.7.0 — Social Reference Discovery Layer**.
...
The current release is **v1.7.0 — Book / Bibliographic Discovery Layer**.
...
The current release is **v1.7.0 — Reference Activation Pack MVP**.
...
The current release is **v1.7.0 — Activation Pack UI Integration**.

...
# Release Package Audit Checklist — v2.1.1
...
- package-lock.json version = `2.1.1`
- package-lock root package version = `2.1.1`
- README.md references `v2.1.1`
- PATCH_MANIFEST.md references `v2.1.1`
- full QA artifact references `2.1.1` after `npm run qa`
...
```bash
git tag -a v2.1.1 -m "v2.1.1 — Release Package Audit"

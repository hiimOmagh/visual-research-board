...
# Release Package Audit Checklist — v2.4.0
...
- package-lock root package version = `2.4.0`
- README.md references `v2.4.0`
- PATCH_MANIFEST.md references `v2.4.0`
- full QA artifact references `2.4.0` after `npm run qa`
...
```bash
git tag -a v2.4.0 -m "v2.4.0 — Release Package Audit"

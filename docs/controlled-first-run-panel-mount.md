...
# Controlled First-Run Panel Mount + UI Consistency — v2.1.4

v2.1.4 mounts the first-run workflow panel in `SearchPanel` using a controlled mount path.
...
- the mount includes the marker `v2.1.4 controlled first-run panel mount`

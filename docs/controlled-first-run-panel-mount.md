...
# Controlled First-Run Panel Mount + UI Consistency — v2.1.3

v2.1.3 mounts the first-run workflow panel in `SearchPanel` using a controlled mount path.
...
- the mount includes the marker `v2.1.3 controlled first-run panel mount`

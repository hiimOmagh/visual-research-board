...
# Controlled First-Run Panel Mount + UI Consistency — v2.1.7

v2.1.7 mounts the first-run workflow panel in `SearchPanel` using a controlled mount path.
...
- the mount includes the marker `v2.1.7 controlled first-run panel mount`

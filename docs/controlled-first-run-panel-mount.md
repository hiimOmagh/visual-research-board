...
# Controlled First-Run Panel Mount + UI Consistency — v2.4.0

v2.4.0 mounts the first-run workflow panel in `SearchPanel` using a controlled mount path.
...
- the mount includes the marker `v2.4.0 controlled first-run panel mount`

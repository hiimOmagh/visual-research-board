...
# Controlled First-Run Panel Mount + UI Consistency — v2.1.1

v2.1.1 mounts the first-run workflow panel in `SearchPanel` using a controlled mount path.
...
- the mount includes the marker `v2.1.1 controlled first-run panel mount`

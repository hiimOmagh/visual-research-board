# Stable Reference Workflow Checklist — v2.0.0
...
- README references v2.0.0.
- PATCH_MANIFEST references v2.0.0.
- validation report references v2.0.0.
- release checklist references v2.0.0.

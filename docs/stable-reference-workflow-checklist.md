# Stable Reference Workflow Checklist — v2.1.11
...
- README references v2.1.11.
- PATCH_MANIFEST references v2.1.11.
- validation report references v2.1.11.
- release checklist references v2.1.11.
...
```bash
git tag -a v2.1.11 -m "v2.1.11 — Reference Workflow Stable Release"

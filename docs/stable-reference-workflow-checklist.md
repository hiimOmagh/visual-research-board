# Stable Reference Workflow Checklist — v2.1.1
...
- README references v2.1.1.
- PATCH_MANIFEST references v2.1.1.
- validation report references v2.1.1.
- release checklist references v2.1.1.
...
```bash
git tag -a v2.1.1 -m "v2.1.1 — Reference Workflow Stable Release"

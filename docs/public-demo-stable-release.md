# Public Demo Stable Release — v2.0.1

Public demo stable release baseline.

v2.0.1 is the stable public-demo release.
...
- The full QA artifact shows `app_version: 2.0.1`, `status: passed`, and `failed_gate_count: 0`.

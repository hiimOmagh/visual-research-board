# Public Demo Stable Release — v1.8.0

Public demo stable release baseline.

v1.8.0 is the stable public-demo release.
...
- The full QA artifact shows `app_version: 1.8.0`, `status: passed`, and `failed_gate_count: 0`.

# Public Demo Stable Release — v2.1.7

Public demo stable release baseline.

v2.1.7 is the stable public-demo release.
...
- The full QA artifact shows `app_version: 2.1.7`, `status: passed`, and `failed_gate_count: 0`.

# Public Demo Stable Release — v2.3.0

Public demo stable release baseline.

v2.3.0 is the stable public-demo release.
...
- The full QA artifact shows `app_version: 2.3.0`, `status: passed`, and `failed_gate_count: 0`.

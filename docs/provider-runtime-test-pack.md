# Provider Runtime Test Pack — v0.2.11

`v0.2.11` adds an explicit runtime validation layer for real-provider evidence. The goal is to separate three different states:

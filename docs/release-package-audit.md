...
# Release Package Audit — v2.4.0

v2.4.0 audits release package readiness for the stable v2 workflow.
...
- app version: `2.4.0`
- release label: `v2.4.0 — Release Package Audit`
- package version: `2.4.0`
- package-lock root version: `2.4.0`
- full QA artifact app version: `2.4.0` after `npm run qa`
- tag: `v2.4.0` after CI is green

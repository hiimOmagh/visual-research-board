...
# Release Package Audit — v2.1.7

v2.1.7 audits release package readiness for the stable v2 workflow.
...
- app version: `2.1.7`
- release label: `v2.1.7 — Release Package Audit`
- package version: `2.1.7`
- package-lock root version: `2.1.7`
- full QA artifact app version: `2.1.7` after `npm run qa`
- tag: `v2.1.7` after CI is green

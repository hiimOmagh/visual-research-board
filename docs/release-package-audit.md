...
# Release Package Audit — v2.1.3

v2.1.3 audits release package readiness for the stable v2 workflow.
...
- app version: `2.1.3`
- release label: `v2.1.3 — Release Package Audit`
- package version: `2.1.3`
- package-lock root version: `2.1.3`
- full QA artifact app version: `2.1.3` after `npm run qa`
- tag: `v2.1.3` after CI is green

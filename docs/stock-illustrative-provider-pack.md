# v1.2.0 — Stock/Illustrative Provider Pack

v1.2.0 adds optional free-key stock/illustrative image retrieval for visual inspiration, thumbnails, moodboards, and background candidates.

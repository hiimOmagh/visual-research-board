...
# Dependency Audit Triage Checklist — v2.4.0

## Run

```bash
npm audit
npm audit --json > artifacts/npm-audit-v2.4.0.json
```
...
- decision: do not force-fix in v2.4.0
...
Initial `npm audit` on v2.4.0 reported:

...
# Dependency Audit Triage Checklist — v2.2.0

## Run

```bash
npm audit
npm audit --json > artifacts/npm-audit-v2.2.0.json
```
...
- decision: do not force-fix in v2.2.0
...
Initial `npm audit` on v2.2.0 reported:

...
# Dependency Audit Triage Checklist — v2.1.3

## Run

```bash
npm audit
npm audit --json > artifacts/npm-audit-v2.1.3.json
```
...
- decision: do not force-fix in v2.1.3
...
Initial `npm audit` on v2.1.3 reported:

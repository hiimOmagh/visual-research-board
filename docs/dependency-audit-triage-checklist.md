...
# Dependency Audit Triage Checklist — v2.1.11

## Run

```bash
npm audit
npm audit --json > artifacts/npm-audit-v2.1.11.json
```
...
- decision: do not force-fix in v2.1.11
...
Initial `npm audit` on v2.1.11 reported:

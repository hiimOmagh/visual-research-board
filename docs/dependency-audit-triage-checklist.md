...
# Dependency Audit Triage Checklist — v2.3.0

## Run

```bash
npm audit
npm audit --json > artifacts/npm-audit-v2.3.0.json
```
...
- decision: do not force-fix in v2.3.0
...
Initial `npm audit` on v2.3.0 reported:

# Real Topic Test Matrix — v0.2.7

`v0.2.7` adds a real-topic test matrix for proving that broad retrieval works across creator-relevant scenarios rather than only one cherry-picked topic.

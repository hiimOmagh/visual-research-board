# Real Topic Test Matrix — v0.3.1

`v0.3.1` adds a real-topic test matrix for proving that broad retrieval works across creator-relevant scenarios rather than only one cherry-picked topic.

# Real Topic Test Matrix — v0.3.0

`v0.3.0` adds a real-topic test matrix for proving that broad retrieval works across creator-relevant scenarios rather than only one cherry-picked topic.

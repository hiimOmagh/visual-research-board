# Release Checklist — v2.3.0 stable
...
## v2.3.0 reference intelligence layer
...
## v2.3.0 broad web image discovery
...
## v2.3.0 social reference discovery
...
## v2.3.0 book bibliographic discovery
...
## v2.3.0 reference activation pack
...
## v2.3.0 first-run visual QA screenshot evidence
...
## v2.3.0 first-run evidence artifact review
...
## v2.3.0 single-command verification
...
## v2.3.0 CI parity workflow badge
...
## v2.3.0 verification freshness lock
...
## v2.3.0 verification artifact schema lock

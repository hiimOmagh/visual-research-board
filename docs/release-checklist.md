# Release Checklist — v2.0.2 stable
...
## v2.0.2 reference intelligence layer
...
## v2.0.2 broad web image discovery
...
## v2.0.2 social reference discovery
...
## v2.0.2 book bibliographic discovery
...
## v2.0.2 reference activation pack

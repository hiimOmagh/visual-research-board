# Release Checklist — v2.1.3 stable
...
## v2.1.3 reference intelligence layer
...
## v2.1.3 broad web image discovery
...
## v2.1.3 social reference discovery
...
## v2.1.3 book bibliographic discovery
...
## v2.1.3 reference activation pack
...
## v2.1.3 first-run visual QA screenshot evidence
...
## v2.1.3 first-run evidence artifact review

# Release Checklist — v1.6.0 stable
...
## v1.6.0 reference intelligence layer
...
## v1.6.0 broad web image discovery
...
## v1.6.0 social reference discovery
...
## v1.6.0 book bibliographic discovery
...
## v1.6.0 reference activation pack

...
# Public Demo Screenshot Checklist — v2.0.3

## screenshot evidence

The public demo should have a screenshot evidence set before tagging v2.0.3.
...
- `v2.0.3-01-landing-default.png`
- `v2.0.3-02-discovery-board.png`
- `v2.0.3-03-activation-pack-workflow.png`
- `v2.0.3-04-export-integration-panel.png`
- `v2.0.3-05-empty-state.png`
- `v2.0.3-06-desktop-width.png`
- `v2.0.3-07-mobile-width.png`

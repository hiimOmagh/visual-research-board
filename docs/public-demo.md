...
Visual Research Board v2.1.4 is a Public Demo Release Candidate.
...
v2.1.4 is a release candidate. It is suitable for public inspection only if the public-demo, security, and full QA gates pass.

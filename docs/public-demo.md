...
Visual Research Board v0.9.0 is a Public Demo Release Candidate.
...
v0.9.0 is a release candidate. It is suitable for public inspection only if the public-demo, security, and full QA gates pass.

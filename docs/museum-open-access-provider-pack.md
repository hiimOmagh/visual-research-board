# v2.1.11 — Museum/Open-Access Provider Pack

v2.1.11 expands the free-source visual retrieval layer with museum, cultural heritage, natural-history, public-record, and digital-library providers.

# v2.1.0 — Museum/Open-Access Provider Pack

v2.1.0 expands the free-source visual retrieval layer with museum, cultural heritage, natural-history, public-record, and digital-library providers.

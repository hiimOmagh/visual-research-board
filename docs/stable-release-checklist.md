# Stable Release Checklist — v2.1.4
...
- The full QA artifact shows `app_version: 2.1.4`.
...
- README, release checklist, and validation report identify v2.1.4.

## Product boundary

v2.1.4 does not introduce broad web/social/book discovery or generation support. Those are post-stable expansion milestones.

# Stable Release Checklist — v1.0.0
...
- The full QA artifact shows `app_version: 1.0.0`.
...
- README, release checklist, and validation report identify v1.0.0.

## Product boundary

v1.0.0 does not introduce broad web/social/book discovery or generation support. Those are post-stable expansion milestones.

# Stable Release Checklist — v2.0.1
...
- The full QA artifact shows `app_version: 2.0.1`.
...
- README, release checklist, and validation report identify v2.0.1.

## Product boundary

v2.0.1 does not introduce broad web/social/book discovery or generation support. Those are post-stable expansion milestones.

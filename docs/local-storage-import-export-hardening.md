...
v2.0.1 adds a storage validation layer around browser-local project libraries.
...
v2.0.1 does not add cloud sync, authentication, server persistence, encryption, or collaborative editing.

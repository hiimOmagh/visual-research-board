...
v1.7.0 adds a storage validation layer around browser-local project libraries.
...
v1.7.0 does not add cloud sync, authentication, server persistence, encryption, or collaborative editing.

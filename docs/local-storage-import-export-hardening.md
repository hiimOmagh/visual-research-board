...
v0.8.1 adds a storage validation layer around browser-local project libraries.
...
v0.8.1 does not add cloud sync, authentication, server persistence, encryption, or collaborative editing.

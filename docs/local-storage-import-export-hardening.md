# v0.7.0 — Local Storage + Import/Export Hardening
...
v0.7.0 adds a storage validation layer around browser-local project libraries.
...
v0.7.0 does not add cloud sync, authentication, server persistence, encryption, or collaborative editing.

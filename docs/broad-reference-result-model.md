# Broad Reference Result Model — v2.1.3

v2.1.3 makes broad reference source classes first-class without adding new providers or changing retrieval behavior.

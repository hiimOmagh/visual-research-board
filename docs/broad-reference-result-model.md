# Broad Reference Result Model — v1.9.0

v1.9.0 makes broad reference source classes first-class without adding new providers or changing retrieval behavior.

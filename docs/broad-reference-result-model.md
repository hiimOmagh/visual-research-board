# Broad Reference Result Model — v2.1.4

v2.1.4 makes broad reference source classes first-class without adding new providers or changing retrieval behavior.

...
v0.8.2 consolidates the project validation surface into one categorized runner.
...
Before v0.8.2, `npm run qa` was a long shell chain. That made it harder to isolate failures, run one family of checks, or attach release evidence. v0.8.2 makes the validation layer inspectable without changing product behavior.

## v0.8.2 security category

# Free Image Retrieval + Reference Search Hub — v0.2.11

`v0.2.11` expands the Visual Research Board from a narrow provider stack into a free-source image discovery workflow.

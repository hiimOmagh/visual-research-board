# Hosted Demo Review Checklist — v2.1.7
...
- The full-qa-gate-report artifact shows `app_version: 2.1.7`.
...
Do not move beyond v2.1.7 until the hosted demo evidence has been reviewed against the committed documentation and QA artifact.

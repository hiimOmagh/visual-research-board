# Hosted Demo Review Checklist — v2.0.0
...
- The full-qa-gate-report artifact shows `app_version: 2.0.0`.
...
Do not move beyond v2.0.0 until the hosted demo evidence has been reviewed against the committed documentation and QA artifact.

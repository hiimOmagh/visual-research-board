# Hosted Demo Review Checklist — v1.3.0
...
- The full-qa-gate-report artifact shows `app_version: 1.3.0`.
...
Do not move beyond v1.3.0 until the hosted demo evidence has been reviewed against the committed documentation and QA artifact.

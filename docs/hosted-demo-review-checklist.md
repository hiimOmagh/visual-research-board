# Hosted Demo Review Checklist — v2.1.5
...
- The full-qa-gate-report artifact shows `app_version: 2.1.5`.
...
Do not move beyond v2.1.5 until the hosted demo evidence has been reviewed against the committed documentation and QA artifact.

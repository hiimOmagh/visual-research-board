# Hosted Demo Review Checklist — v1.9.0
...
- The full-qa-gate-report artifact shows `app_version: 1.9.0`.
...
Do not move beyond v1.9.0 until the hosted demo evidence has been reviewed against the committed documentation and QA artifact.

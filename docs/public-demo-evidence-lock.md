# Public Demo Evidence Lock — v2.1.4

v2.1.4 locks public-demo evidence after the Public Demo Release Candidate and Release Warning Cleanup passed.
...
v2.1.4 is locked only when local validation and CI both pass with a produced full QA evidence artifact.

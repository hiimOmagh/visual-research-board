# Public Demo Evidence Lock — v0.8.2

v0.8.2 locks public-demo evidence after the Public Demo Release Candidate and Release Warning Cleanup passed.
...
v0.8.2 is locked only when local validation and CI both pass with a produced full QA evidence artifact.

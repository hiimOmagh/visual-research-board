# Public Demo Evidence Lock — v1.7.0

v1.7.0 locks public-demo evidence after the Public Demo Release Candidate and Release Warning Cleanup passed.
...
v1.7.0 is locked only when local validation and CI both pass with a produced full QA evidence artifact.

# Evidence-Driven Ranking / Query Tuning — v0.2.10

`v0.2.10` turns the runtime evidence layer into an explicit ranking and query-tuning layer.
...
A good v0.2.10 run should show:

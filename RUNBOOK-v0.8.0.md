# v0.8.2 Public Demo Release Candidate — Runbook

## Preconditions

Apply `visual-research-board-v0.8.2-security-key-handling-patch.zip` first if the repo is not already on v0.8.2.

The v0.8.2 patch expects the v0.8.2 Full QA Gate and Security/Key Handling baseline:
...
```bash
node apply-v0.8.2-public-demo-rc.mjs
```
...
git commit -m "chore: prepare v0.8.2 public demo release candidate"
```

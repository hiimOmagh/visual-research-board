  ...
  return (
    <section className="mb-6 rounded-[2rem] border border-white/10 bg-slate-950/70 p-5 shadow-soft">
      ...
      <p className="mt-3 text-xs leading-5 text-slate-500">
        v2.4.0 stores a local multi-project library with persistent result snapshots, conflict-safe import/export bundles, backup envelopes, validation reports, corrupted-file warnings, and guided demo/onboarding support in browser localStorage. Existing projects are never overwritten by an import.
      </p>
      {storageImportReport && (

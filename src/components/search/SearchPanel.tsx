...
import { ProviderTogglePanel /* v2.4.0 provider setup clarity */ } from "@/components/search/ProviderTogglePanel";
...
export const PROVIDER_TOGGLE_PANEL_SETUP_CLARITY_CONTRACT = {
  ...
  app_version: "2.4.0",
  marker: "v2.4.0 provider setup clarity",
  gate: "ux-reliability",
} as const;
...
export function SearchPanel() {
  ...
  const exportLibrary = () => {
    downloadTextFile("visual-research-board-library-v2.4.0.json", createProjectLibraryExport(library), "application/json");
  };

  const exportBackup = () => {
    downloadTextFile("visual-research-board-backup-v2.4.0.json", createStorageBackupExport(library), "application/json");
  };

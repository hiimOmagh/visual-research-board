...
// v2.1.3 first-run workflow copy is provided by FirstRunWorkflowPanel.
...
export function SearchPanel() {
  ...
  const exportLibrary = () => {
    downloadTextFile("visual-research-board-library-v2.1.3.json", createProjectLibraryExport(library), "application/json");
  };

  const exportBackup = () => {
    downloadTextFile("visual-research-board-backup-v2.1.3.json", createStorageBackupExport(library), "application/json");
  };
  ...
  return (
    <main className="mx-auto min-h-screen max-w-[96rem] px-4 py-6 sm:px-6 lg:px-8">
      <header className="mb-6 rounded-[2rem] border border-white/10 bg-white/[0.04] p-6 shadow-soft">
        <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-3xl">
            <p className="text-xs uppercase tracking-[0.32em] text-lime-300">v2.1.3</p>
      ...
      {/* v2.1.3 controlled first-run panel mount */}

...
export function SearchPanel() {
  ...
  const exportLibrary = () => {
    downloadTextFile("visual-research-board-library-v1.9.0.json", createProjectLibraryExport(library), "application/json");
  };

  const exportBackup = () => {
    downloadTextFile("visual-research-board-backup-v1.9.0.json", createStorageBackupExport(library), "application/json");
  };
      ...
      <header className="mb-6 rounded-[2rem] border border-white/10 bg-white/[0.04] p-6 shadow-soft">
        <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-3xl">
            <p className="text-xs uppercase tracking-[0.32em] text-lime-300">v1.9.0</p>

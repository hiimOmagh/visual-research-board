      ...
      <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
        <div>
          ...
          <p className="mt-2 text-xs leading-5 text-slate-400">
            Shows whether this running surface can execute live provider calls. Static GitHub Pages is mock/reference-only; a Next.js runtime is required for live free backend providers. Brave/Tavily are optional and disabled by default in v0.2.10.
          </p>
        </div>

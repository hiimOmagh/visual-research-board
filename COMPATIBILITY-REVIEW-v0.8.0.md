...
This patch is built on v0.7.1 — Security and Key Handling.
...
The public-demo checker scans public-facing docs and UI helper files for unsafe capability claims and secret-looking values. It also checks that v0.7.1 security scripts and security gate references remain present.

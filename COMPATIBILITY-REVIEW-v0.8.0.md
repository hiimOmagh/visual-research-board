# Compatibility Review — v0.8.2 Public Demo Release Candidate

## Baseline

This patch is built on v0.8.2 — Security and Key Handling.
...
The public-demo checker scans public-facing docs and UI helper files for unsafe capability claims and secret-looking values. It also checks that v0.8.2 security scripts and security gate references remain present.
